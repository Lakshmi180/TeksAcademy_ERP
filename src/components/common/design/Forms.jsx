                ...
                <div class="live-preview">
                  <div class="row gy-4 ">
                    ...
                    <div class="col-xxl-3 col-md-6">
                      <div>
                        <div class="form-group text-start">
                          <label class="form-label fsize" for="example-text-input ">
                            {" "}
                            Input with Label
                          </label>
                          <input
                    ...
                    <div class="col-xxl-3 col-md-6">
                      <div>
                        <div class="form-group text-start">
                          ...
                          <input
                            class="form-control-plaintext fsize"
                            type="text"
                    ...
                    <div class="col-xxl-3 col-md-6">
                      <div>
                        <div class="form-group text-start">
                          <label class="form-label  fsize" for="readonlyInput">
                            Readonly Input
                          </label>
                          <input
                            class="form-control fsize"
                            type="text"
                            id="readonlyInput"
                            value="Readonly input"
                            radioGroup=""
                    ...
                    <div class="col-xxl-3 col-md-6">
                      <div>
                        <div class="form-group text-start">
                          <label class="form-label fsize" for="disabledInput">
                            Disabled Input
                          </label>
                          <input
                            class="form-control fsize"
                    ...
                    <div class="col-xxl-3 col-md-6">
                      <div>
                        <div class="text-start">
                          <label class="form-label fsize" for="iconInput">
                            Input with Icon
                          </label>
                          <div class="form-icon d-flex">
                            <input
                              class="form-control form-control-icon fsize"
                              type="email"
                              id="iconInput"
                    ...
                    <div class="col-xxl-3 col-md-6">
                      <div>
                        <div class="form-group text-start">
                          <label class="form-label fsize" for="colorPicker ">
                            Color Picker
                          </label>
                          <input
                    ...
                    <div class="col-xxl-3 col-md-6">
                      <div>
                        <div class="form-group text-start">
                          ...
                          <input
                            class="form-control border-dashed fsize"
                            type="text"
                            id="borderInput"
                    ...
                    <div class="col-xxl-3 col-md-6">
                      <div>
                        <div class="form-group text-start">
                          <label class="form-label fsize" for="exampleDataList ">
                            Datalist example
                          </label>
                          <input
                            class="form-control fsize"
                    ...
                    <div class="col-xxl-3 col-md-6">
                      <div>
                        <div class="form-group text-start">
                          ...
                          <input
                            class="form-control rounded-pill fsize"
                            type="text"
                            id="example-text-input"
                            placeholder="enter your name"
                          />
          ...
          <div class="row fs-6">
            ...
            <div class="card-body m-3">
              <div class="row align-items-center text-start g-3 fsize">
                <div class="col-lg-4">
                  <div>
                    <label for="formfile" class="form-label fsize">
                ...
                <div class="col-lg-4 ">
                  <div>
                    <label for="formFileMultiple" class="form-label fsize">
                ...
                <div class="col-lg-4">
                  <div>
                    <label for="formFileDisabled" class="form-label fsize">
              ...
              <div class="row g-3">
                ...
                <div class="col-lg-6 fsize">
                  ...
                  <div class="input-group mb-3 fsize">
                    <span class="input-group-text fsize" id="basic-addon3">
          ...
          <div class="row mt-4 p-3 mb-3 bg-body rounded bg-white ">
            <div className="col-lg-6 mb-2">
              <div className="card d-flex">
                ...
                <div className="card-body ">
                  <p className="fsize text-muted mb-2">
            ...
            <div className="col-lg-6">
              <div className="card d-flex">
                <div className="card-header">
                  <h4 className=" card-title fs-6">Profile Picture Selection</h4>
                </div>
                <div className="card-body ">
                  <p className="fsize text-muted mb-2">
                      ...
                      <div className="row d-flex">
                        <div className="col-md-6">
                          <div class="mb-3">
                            <label
                              for="firstNameinput"
                              className="form-label form-fsize fw-medium"
                            >
                              First Name
                            </label>
                            <input
                              type="text"
                              className="form-control form-fsize"
                              placeholder="Enter your firstname"
                              id="firstNameinput"
                            />
                          </div>
                        ...
                        <div className="col-md-6">
                          <div className="mb-3">
                            <label
                              for="ForminputState"
                              className="form-label fw-medium form-fsize"
                            >
                              State
                            </label>
                        ...
                        <div className="col-lg-12">
                          <div className="text-end">
                            <button
                              type="submit "
                              className="btn btn-primary form-fsize fw-medium"
                            >
                              Submit
                            </button>
                          </div>
          ...
          <div className="row  ">
            <div className="col-xxl-6 mb-2">
              <div className="card d-flex">
                ...
                <div className="card-body">
                  <p className="text-muted fsize">Example of vertical form using <code>form-control</code> class. No need to specify row and col class to create vertical form.</p>
                  <div className="live-preview">
                    <form action="javascript:void(0);">
                      <div className="mb-3">
                        <label for="employeeName " className="form-label fw-medium form-fsize">
                          Employee Name
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="mb-3">
                        <label for="employeeUrl" className="form-label fw-medium form-fsize">
                      ...
                      <div className="mb-3">
                        <label for="StartleaveDate" className="form-label fw-medium form-fsize">
                          Start Leave Date
                        </label>
                        <input
                          type="text"
                          className="form-control flatpickr-input form-fsize"
                      ...
                      <div className="mb-3">
                        <label for="EndleaveDate" className="form-label fw-medium form-fsize">
                          End Leave Date
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="mb-3">
                        <label for="VertimeassageInput" className="form-label fw-medium form-fsize">
                          Message
                        </label>
                        <textarea
                          className="form-control form-fsize"
                      ...
                      <div className="text-end">
                        <button type="submit" className="btn btn-primary fw-medium form-fsize">
                          Add Leave
                        </button>
                      </div>
                    </form>
            ...
            <div className="col-xxl-6 ">
              <div className="card d-flex">
                <div className="card-header fsize">
                  <h4 className="fs-6">Horizontal Form</h4>
                </div>
                <div className="card-body">
                  <p className="text-muted fsize">Create horizontal forms with the grid by adding the <code>row</code> class to form groups and using the <code>col-*-*</code> class to specify the width of your labels and controls. Be sure to add <code>col-form-label</code> class to your <code>&lt;label&gt;</code>s as well so they’re vertically centered with their associated form controls.</p>
                  <div className="live-preview">
                    <form action="javascript:void(0);">
                      <div class="row mb-3">
                        <div className="col-lg-3">
                          <label for="nameInput" className="form-label fw-medium form-fsize">Name</label>
                        </div>
                        <div className="col-lg-9">
                          <input type="text" className="form-control form-fsize" id="nameInput" placeholder="Enter your name" />
                        </div>
                      </div>
                      <div className="row mb-3">
                        <div className="col-lg-3">
                          <label for="websiteUrl" className="form-label fw-medium form-fsize">Website URL</label>
                        </div>
                        <div className="col-lg-9">
                          <input type="url" className="form-control form-fsize" id="websiteUrl" placeholder="Enter your url" />
                        </div>
                      </div>
                      <div className="row mb-3">
                        <div className="col-lg-3">
                          <label for="dateInput" className="form-label fw-medium form-fsize">Date</label>
                        </div>
                        <div className="col-lg-9">
                          <input type="text" className="form-control flatpickr-input form-fsize" data-provider="flatpickr" id="dateInput" readonly="readonly" />
                        </div>
                      </div>
                      <div className="row mb-3">
                        <div className="col-lg-3">
                          <label for="timeInput" className="form-label fw-medium form-fsize">Time</label>
                        </div>
                        <div className="col-lg-9">
                          <input type="text" className="form-control flatpickr-input form-fsize" data-provider="timepickr" data-time-basic="true" id="timeInput" readonly="readonly" />
                        </div>
                      </div>
                      <div className="row mb-3">
                        <div className="col-lg-3">
                          <label for="leaveemails" className="form-label fw-medium form-fsize">Email Id</label>
                        </div>
                        <div className="col-lg-9">
                          <input type="email" className="form-control form-fsize" id="leaveemails" placeholder="Enter your email" />
                        </div>
                      </div>
                      <div className="row mb-3">
                        <div className="col-lg-3">
                          <label for="contactNumber" className="form-label fw-medium form-fsize">Contact Number</label>
                        </div>
                        <div className="col-lg-9">
                          <input type="number" className="form-control form-fsize" id="contactNumber" placeholder="
                                                    Enter contact number"/>
                        </div>
                      </div>
                      <div className="row mb-3">
                        <div className="col-lg-3">
                          <label for="meassageInput" className="form-label fw-medium form-fsize">Message</label>
                        </div>
                        <div className="col-lg-9">
                          <textarea className="form-control form-fsize" id="meassageInput" rows="3" placeholder="Enter your message"></textarea>
                        </div>
                      </div>
                      <div className="text-end">
                        <button type="submit" className="btn btn-primary fw-medium form-fsize">Add Leave</button>
                      </div>
                    </form>
                  </div>
                </div>
