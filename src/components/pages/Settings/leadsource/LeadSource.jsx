...
const LeadSource = () => {
  ...
  const handleLeadSources = async (id) => {
    let leadID = { id: id };
    try {
      const { data, status } = await toast.promise(
        axios.delete(
          `${process.env.REACT_APP_API_URL}/deleteleadsource/${id}`,
          id
        ),
        {
          loading: "Loading...",
      ...
      if (status === 200) {
        ...
        // DispatchCourseState({ type: "DELETE_COURSE", payload: leadID });
      }
    } catch (error) {
      console.log(error);
    }
              ...
              <div className="card-header">
                <div className="d-flex justify-content-between">
                  ...
                  <div>
                    ...
                    >
                      <Link to="/createleadsource" className="button_color">
